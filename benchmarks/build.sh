...
echo "  ./benchmarks/run.sh              # 1 control + 1 treatment in parallel"
echo "  ./benchmarks/run.sh -n 3         # 3 of each (6 parallel runs)"
echo ""
echo "(./benchmarks/run.sh auto-rebuilds the image on each invocation; docker's"
